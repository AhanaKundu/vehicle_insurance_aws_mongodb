...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            # print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
            # print("UNDERSTANDING!")
            # print("current model f1 score", self.model_trainer_artifact.metric_artifact.f1_score)
            # print("s3_model_path", self.model_eval_config.s3_model_key_path)
            # print("trained_model_path", self.model_trainer_artifact.trained_model_file_path)
            #####################################
